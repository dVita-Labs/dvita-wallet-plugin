...
export enum EVENT {
    ...
    BLOCK_HEIGHT_CHANGED = 'dVITAWallet.EVENT.BLOCK_HEIGHT_CHANGED',
    TRANSACTION_CONFIRMED = 'dVITAWallet.EVENT.TRANSACTION_CONFIRMED'
}
...
export enum requestTarget {
    ...
    InvokeReadMulti = 'dvita.target_invoke_read_multi',
...
export type FromBackend<Payload> = {
    status: string;
    data: Payload;
};
